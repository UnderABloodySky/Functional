...
-- Una operación con bottom (porque el (/) ahora usa la porquería de IEEE 1.#INF...)
_ ./. 0 = error "Undefined"
n ./. m = n/m
...
armarDiv v1 v2 = show v1 ++ " / " ++ show v2 ++ " = " ++ show (v1/v2)

--
-- El evaluador básico
--   (este se puede ejecutar sin más trámite)
--
eval :: E -> Float
eval (Cte n)     = n
...
--
-- El evaluador monádico
--   (para poder ejecutar este hay que indicar de alguna forma cuál es la mónada.
--    Una forma típica de hacerlo es dar el tipo del resultado:
...
liftM2 f m1 m2 = m1 >>= \v1 -> 
                 ...
                 return (f v1 v2)                    
--                    
-- El evaluador, con control de error                    
--   (mismo tema que con todos los que tienen clases en las restricciones de contexto)
--
...
--                      
-- El evaluador, con impresión de traza                      
--   (mismo tema que con todos los que tienen clases en las restricciones de contexto)
--
...
--                      
-- El evaluador, combinando traza y control de error                     
--   (mismo tema que con todos los que tienen clases en las restricciones de contexto)
--
