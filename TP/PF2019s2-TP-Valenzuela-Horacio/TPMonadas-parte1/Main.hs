...
import OutputErrorMonad    -- La definición de la mónada OutputError (COMPLETAR)
import Eval                -- La aplicación de prueba (diferentes evals para E)

main = probar 2

probar :: Int -> IO ()
-- probar i = do print (pruebaMPE i)
...
pruebaMPE :: Int -> OutputErrorMonad Float
